      ...
      <div className="footer__inner">
        <div className="footer__top">
          <div className="footer__brand">
            <h3 className="footer__logo">FanMunch</h3>
            <p className="footer__tagline">Stadium food, delivered to your seat</p>
          </div>
          ...
          <div className="footer__links">
            <div className="footer__column">
              ...
              <ul className="footer__list">
                ...
                <li><a href="#" className="footer__link">Stadiums</a></li>
                <li><a href="#" className="footer__link">For Vendors</a></li>
        ...
        <div className="footer__bottom">
          <div className="footer__copyright">
            <p>&copy; 2024 FanMunch. All rights reserved.</p>
          </div>
